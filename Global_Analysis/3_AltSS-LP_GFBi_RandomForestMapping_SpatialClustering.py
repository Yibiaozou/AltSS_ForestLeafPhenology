...
holdingFolder = 'D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Code/GEE_RF/Input_FSD'

# Name of a local folder for output data
outputFolder = 'D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Code/GEE_RF/Output_FSD'
...
if (assetIDForCVAssignedColl in files_present):
	...
	# Write to file
	GEE_FC_to_pd(fcOI).to_csv('D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Code/GEE_RF/Output_FSD/'+classProperty+'_training_data.csv')
