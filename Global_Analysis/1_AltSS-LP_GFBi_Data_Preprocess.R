...
GFBI_Df1 <- read.csv("D:/Zeus/ETH_zurich_MSc/ETHz_S3/Internship_Nick_Lab/Data/GFBI/GFBI_Tree_Level/GFBI_Tree_Level.csv") 
...
save(GFBI_Df1, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/GFBI_Lab_Full.R")
...
write.csv(GFBI_Df2_coordinates, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/GFBI_Df2_coordinates_new.csv", row.names = F)
...
GFBI_Df2_covariates <- read.csv("D:/Zeus/ETH_zurich_MSc/ETHz_S2/Eco_Evo_ETH-D_assistantship/Leaf_Phenology_Project/Code/Niubi_transform/CovariatesExtracted_GFBI/20221013_GFBI_Yibiao.csv")
...
saveRDS(GFBI_Df2_Aggregated_Full_2, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/GFBI_Df2_aggregated_New.rds")

## get the names of spatial covariates
GMP_Df_Full =read.csv("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Code/GEE_RF/Input_Full/GMP_Df_Full.csv")
...
saveRDS(GFBI_Df3_Scaled_10min, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/GFBI_Df3_Scaled_10min_FullStandardized.rds")
...
write.csv(GFBI_Df3_scaled_10min_RF, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Code/GEE_RF/Input_FSD/GMP_Df_FSD.csv", row.names = F)
...
toc()
saveRDS(AltSS_LP_RF_Caret_FSD_AllCovariates, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/AltSS_LP_RF_Caret_FSD_AllCovariates.rds")
...
## save the dataset
saveRDS(GFBI_Df2_Aggregated_Full_2_Clim_Kmeans, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/GFBI_Df2_Aggregated_Full_2_PCA_Kmeans_FSD.rds")
...
write.csv(GFBI_Df3_Scaled_PCA_Full_Kmeans, 
          file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Code/GEE_RF/Input_PCA/GMP_Df_PCA_Kmeans_FSD.csv",
          row.names=F)
...
GFBI_Df3_Scaled_PCA_Full_Kmeans <- readRDS("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/GFBI_Df3_Scaled_PCA_Full_Kmeans_FSD.rds")
...
toc()
saveRDS(AltSS_LP_RF_PCA_Full_Kmeans, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/AltSS_LP_RF_PCA_Full_Kmeans_FSD.rds")
