...
AzapMx <- readRDS("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/EU_zapMx_EV_FSD.rds")
BzapMx <- readRDS("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/EU_zapMx_DE_FSD.rds")
iterations=1000
...
AbnMx <- readRDS("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/EU_bnMx_EV_FSD.rds")
BbnMx <- readRDS("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/EU_bnMx_DE_FSD.rds")
iterations=1000
GebnMx_Bi <- numeric(iterations)
KebnMx_Bi <- numeric(iterations)
binwidthx = 0.05
...
AbnMx <- readRDS("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/FIA_bnMx_EV_FSD.rds")
BbnMx <- readRDS("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/FIA_bnMx_DE_FSD.rds")
...
AbnMx <- readRDS("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/GFBI_bnMx_EV_sub.rds")
BbnMx <- readRDS("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/GFBI/GFBI_bnMx_DE_sub.rds")
iterations=1000
GebnMx_Bi <- numeric(iterations)
KebnMx_Bi <- numeric(iterations)
binwidthx = 0.05
