...
BI_bestRfModel_SpatialClustering <- raster("**/Global_Analysis/Model_Output/Global_AltssLP_BI_bestRfModel_FSD.tif")
# check the map
...
BI_bestRfModel_SpatialClustering_90interpolation <- BI_bestRfModel_SpatialClustering[Global_PCA_IntExt<0.9] <- NA
