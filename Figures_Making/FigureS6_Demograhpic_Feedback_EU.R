...
library(mgcv)
library(data.table)
source('**/Continental_Analysis/FIA_US/Project_Functions/predict_gam_well.r')
library(tidyverse)
library(raster)
...
#Load fits
fit <- readRDS("**Continental_Analysis/FunDivEurope_EU/Model_Output/demographic_fits_gam_separate_FunDivEurope_FSD.rds")
...
FunDivEUROPE_trees_EU_Full <- readRDS("**Continental_Analysis/FunDivEurope_EU/Data/FunDivEUROPE_trees_EU_Full.rds")
