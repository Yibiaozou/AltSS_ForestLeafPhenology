...
FunDivEUROPE_plots_DE_SW_ES <- read.csv("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/FunDivEurope/FunDivEurope_Inventory_DE_SW_ES_2022-09/FunDivEUROPE_plots_DE_SW_ES.csv")
FunDivEUROPE_species <- read.csv("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/FunDivEurope/FunDivEurope_Inventory_DE_SW_ES_2022-09/FunDivEUROPE_species.csv")
FunDivEUROPE_trees_DE_SW_ES <- read.csv("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/FunDivEurope/FunDivEurope_Inventory_DE_SW_ES_2022-09/FunDivEUROPE_trees_DE_SW_ES.csv")
...
FunDivEUROPE_plots_FI_WA <- read.csv("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/FunDivEurope/FunDivEUROPE_plots_FI_WA.csv")
FunDivEUROPE_trees_FI_WA <- read.csv("D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/FunDivEurope/FunDivEUROPE_trees_FI_WA.csv")
...
saveRDS(FunDivEUROPE_trees_EU_Full, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/FunDivEurope/FunDivEurope_Inventory_DE_SW_ES_2022-09/FunDivEUROPE_trees_EU_Full.rds")
...
saveRDS(FunDivEUROPE_plots_EU_Full, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/FunDivEurope/FunDivEurope_Inventory_DE_SW_ES_2022-09/FunDivEUROPE_plots_EU_Full.rds")
...
write.csv(FunDivEUROPE_Coordinates,row.names = F, file="D:/Zeus/ETH_zurich_MSc/ETHz_S4/MatserThesis_Crowther_Lab/Data/FunDivEurope/FunDivEUROPE_Coordinates.csv")

# load spatial environmental covariates from the lab composite
FunDivEUROPE_covariates <- read.csv("D:/Zeus/ETH_zurich_MSc/ETHz_S2/Eco_Evo_ETH-D_assistantship/Leaf_Phenology_Project/Code/Niubi_transform/CovariatesExtracted/20220925_FunDivEUROPE.csv")
